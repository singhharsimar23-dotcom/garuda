...
logger = logging.getLogger("garuda.lib.llm")
...
class ResilientLLMClient:
    ...
    def __init__(
        ...
        # Prioritize explicitly configured model if provided
    ...
    async def generate_completion(
        ...
        """
        Executes cascade across Groq models -> Gemini models -> Offline Deterministic Template.
        Returns (sanitized_response: str, provider_used: str)
        """
        # Tier 1: Try Groq model chain
    ...
    async def _call_groq(
        ...
        """Execute OpenAI-compatible chat completion on Groq."""
    ...
    async def _call_gemini(
        ...
        """Execute Google Gemini API content generation."""
    ...
    def _sanitize_anti_hallucination(self, text: str) -> str:
        """Enforces Anti-Hallucination Charter by stripping illegal attribution confidence percentages."""
        # Replace 'Confidence: XX%' or 'with XX% confidence'
        cleaned = re.sub(
        ...
        # Replace standalone attribution percentages near threat actors
        cleaned = re.sub(
